...
df$distance <- sqrt((df$x-100)^2 + (df$y - 100)^2)  # Euclidean distance from (0,100)

# Select the 6,006 closest points to the top-left
corner_selected <- order(df$distance)[1:2754]  # Smallest distances first
...
# Save the plot
ggsave("image4.png", width = 10, height = 6, dpi = 300)
